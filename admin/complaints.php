			...
			<div class="panel-body">
				...
				<form method="POST" enctype="multipart/form-data">
					...
					<div style="float:right;" class="form-inline">
						...
						<input class="form-control" size="3" value="<?php echo $f['family_no'] ? $f['family_no'] : ''; ?>" disabled="disabled" type="number" name="family_no">
					</div>
					<br />
					<br />
					<br />
					...
					<div class="form-group">
						...
						<input type="date" name="complaint_date" class="form-control" required="required">
						<br />
